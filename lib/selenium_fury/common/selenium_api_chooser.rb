module SeleniumFury
  module SeleniumApiChooser
    ...
    def validate(page_object, *live_url)
      unless browser.nil?
        SeleniumFury::SeleniumClient::PageValidator.check_page_file_class(page_object, *live_url)
      end
      unless driver.nil?
        SeleniumFury::SeleniumWebDriver::PageValidator.web_driver_validate(page_object, *live_url)
      end
    end
