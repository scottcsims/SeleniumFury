...
Jeweler::Tasks.new do |gem|
  ...
  gem.summary = s.summary = %q{ Selenium Fury allows an automated tester to quickly build page files to use in the page object pattern.  Each page file represents
